    ...
    class PartidaDeXadrez
    {
        ...
        public Peca ExecutaMovimento(Posicao origem, Posicao destino)
        {
            ...
            if (p is Peao)
            {
                if (origem.Coluna != destino.Coluna && pecaCapturada == null)
                {
                    ...
                    pecaCapturada = Tab.RetirarPeca(posicaoPeaoCapturar);
                    _capturadas.Add(pecaCapturada);
                }
            }
        ...
        public void DesfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if (p is Peao)
            {
                ...
                {
                    Peca peaoCapturadoEnPassant = Tab.RetirarPeca(destino);
                    Posicao posicaoPeaoDesfazerEnPassant;
                    if (p.Cor == Cor.Branca)
                    {
                        posicaoPeaoDesfazerEnPassant = new Posicao(3, destino.Coluna);
                    }
                    else
                    {
                        posicaoPeaoDesfazerEnPassant = new Posicao(4, destino.Coluna);
                    }
                    Tab.ColocarPeca(peaoCapturadoEnPassant, posicaoPeaoDesfazerEnPassant);
                }
            }
